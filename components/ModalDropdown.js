...
export default class ModalDropdown extends Component {
			...
			<TouchableOpacity
				...
				{children || (
					<View style={styles.button}>
						<Text style={[styles.buttonText, textStyle]} numberOfLines={1} ellipsizeMode={'tail'}>
							{buttonText}
						</Text>
					</View>
				)}
	...
	_renderDropdown() {
		const { scrollEnabled, options, renderSeparator, showsVerticalScrollIndicator, keyboardShouldPersistTaps } =
			this.props
		return (
			<FlatList
